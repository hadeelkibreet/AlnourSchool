                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Padding(
                        ...
                        children: [
                          ...
                          Align(
                            alignment: Alignment.centerLeft,
                              ...
                              child: ElevatedButton(
                                ...
                                child:
                                Row(children: [
                                  Image.asset(ImageAssets.whatsapp,width: 40,),
                                  SizedBox(width: 10,),
                                  Text(WhatsappNumber,
                                    style: TextStyle(fontSize: 25,fontFamily: 'omnes'),
                                  ),
                                ],),
                              )
                            ),
                          ...
                          Align(
                            ...
                            child: ElevatedButton(
                              ...
                              child:
                                  Row(children: [
                                    Image.asset(ImageAssets.phone,width: 40,),
                                    SizedBox(width: 10,),
                      ...
                      child:
                      Row(children: [
                        Image.asset(ImageAssets.insta,width: 40,),
                        SizedBox(width: 10,),
                      ...
                      Row(
                        children: [
                        Image.asset(ImageAssets.gmail,width: 40,),
                          SizedBox(width: 10,),

                          Text(email,
                          style: TextStyle(fontSize: 16,fontFamily: 'omnes'),
                        ),
                      ],),
                    )
                          ),
